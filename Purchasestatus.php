                        ...
                        ?>
                                    ...
                                    <tr class="bg-white border-b hover:bg-gray-50 ">
                                        ...
                                        <td class="py-4 px-6">
                                            <?php
                                                  $symbol = "₹";     
                                            echo htmlentities($symbol." ".$row['amount']); ?>
                                        </td>
                                        <td class="py-4 px-6">
                                                ...
                                                <?php if ($row['status'] !='Item_Received')
                                    {
                                        ?>
                                                <button
                                                    class="focus:outline-none text-white bg-sky-800 hover:bg-sky-900 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 "
                                      ...
                                      ?>
                                                ...
                                                <button
                                                    class="focus:outline-none text-white bg-pink-500  focus:ring-4 focus:ring-pink-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 "
