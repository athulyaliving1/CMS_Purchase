                                    ...
                                    <tr class="bg-white border-b hover:bg-gray-50 ">
                                        ...
                                        <td class="flex items-center py-4 px-6 space-x-3 place-content-center ">
                                            <div>
                                                ...
                                                <a href="pvendorlistedit.php?edit=<?php echo $row['id']; ?>   "
                                            ...
                                            <div>
                                                <button><a href="pvendorlist.php?del=<?php echo $row['id']; ?>"
                            ...
                            <div>
                                ...
                                <div class="flex justify-center">
                                    ...
                                    for ($page_number = 1; $page_number <= $total_pages; $page_number++) {
                                        ...
                                        echo '<a href = "pvendorlist.php?page=' . $page_number . '">' . $page_number . ' </a>';
                                    }
