                    ...
                    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                            ...
                            <table class="w-full">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3">Location<i class="baseline-near_me"></i></th>
                                        <th class="px-4 py-3">Department</th>
                                        <th class="px-4 py-3">Place<i class="baseline-near_me"></i></th>
                                        <th class="px-4 py-3">Product</th>
                                        <th class="px-4 py-3">Price ₹</th>
                                        <th class="px-4 py-3">Qty</th>
                                        <th class="px-4 py-3">Vendor</th>
                                        <th class="py-3">Approved</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                        ...
                        ?>
                                    ...
                                    <tr class="bg-white border-b hover:bg-gray-50 ">
                                        ...
                                        <td class="flex items-center py-4    place-content-center ">
                                            <div>
                                                <a href="createpo.php?id=<?php echo $row['id']; ?>   "
                                                    class="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-pink-500 border border-pink-800 rounded-md shadow-sm hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-900">create
                                                    P.O</a>
                                            </div>
